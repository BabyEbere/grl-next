      ...
      <main>
        ...
        <section className="relative py-24 bg-[#060f1e] overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
            ...
            <h1 className="font-display font-black text-5xl text-white mb-4">Our Blog</h1>
            ...
            {posts.length > 0 ? (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                {posts.map(post => {
                  ...
                  return (
                    <article key={post.id} className="bg-white rounded-[2rem] overflow-hidden shadow-sm hover:shadow-xl transition-all group flex flex-col h-full border border-gray-100">
                      ...
                      <div className="p-8 flex-1 flex flex-col">
                        ...
                        <h2 className="font-display font-black text-2xl text-[#060f1e] leading-tight mb-4 group-hover:text-amber-600 transition-colors">
              ...
              <div className="text-center py-24 bg-white rounded-[3rem] shadow-sm border border-gray-100">
                <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6 text-gray-300">
                   <i className="ri-article-line text-5xl"></i>
                </div>
                <h3 className="text-[#060f1e] font-black text-2xl mb-3">No articles yet</h3>
                <p className="text-gray-500 max-w-sm mx-auto">We are currently preparing informative content for you. Please check back soon!</p>
              </div>
            )}
        ...
        <section className="py-20 bg-white border-t border-gray-100">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="font-display font-black text-3xl text-[#060f1e] mb-4">Stay in the Loop</h2>
            <p className="text-gray-500 mb-8">Get the latest industry news and corporate updates delivered to your inbox.</p>
            <div className="flex flex-col sm:flex-row gap-3">
              <input 
                type="email" 
                placeholder="Enter your email address" 
                className="flex-1 bg-gray-50 border border-gray-200 rounded-2xl px-6 py-4 outline-none focus:border-amber-500 transition-colors"
              />
              <button className="bg-[#060f1e] text-white font-black px-8 py-4 rounded-2xl hover:bg-[#0f1f3d] transition-all shadow-lg">
                Subscribe
              </button>
            </div>
